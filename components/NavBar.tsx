...
export const NavBar = () => {
  return (
    <div className="px-6 flex items-center justify-center w-full py-5 bg-[#121212]">
      <div className="max-w-6xl w-full flex flex-row">
        <NavigationMenu.Root>
          <NavigationMenu.List className="flex flex-row font-medium gap-x-10 w-full items-center">
            <NavigationMenu.Item>
